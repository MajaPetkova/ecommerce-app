  ...
  return (
    <form className='flex flex-col w-full items-start gap-3'>
        ...
        <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
            ...
            <input className='w-full px-3 py-2 sm:w-[120px]' type="number" placeholder='25' /></div>
        </div>
        <div>
        ...
        <div className='flex gap-2 mt-2'><input type="checkbox"  id='bestseller'/>
        <label className='cursor-pointer' htmlFor="bestseller">Add to bestseller</label></div>
